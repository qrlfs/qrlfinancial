...
$(document).ready(function() {
  ...
  if ($(".partner-home").length) {
    ...
    $(".partner-home-wrap>.col-md-3").addClass("partner-home-col-1 collapse in").attr("id", "collapsePipe").attr("aria-expanded", "true");
    ...
    $("#collapsePipe").on("hidden.bs.collapse", function () {
      $(".partner-home-col-2").switchClass("col-md-9", "col-md-12");
    });
    $("#collapsePipe").on("shown.bs.collapse", function () {
      $(".partner-home-col-2").switchClass("col-md-12", "col-md-9");      
    });
  }
  // add favicon
